...
public class CalculatorMain {
    public static void main(String[] args) {
        ...
        double result1 = 10 * 10 * com.javalab.sec08.Calculator.pi;
        // 정적 메소드는 클래스이름.메소드명으로 접근
        int result2 = com.javalab.sec08.Calculator.plus(10, 5);
        // 정적 메소드는 클래스이름.메소드명으로 접근
        int result3 = com.javalab.sec08.Calculator.minus(10, 5);
